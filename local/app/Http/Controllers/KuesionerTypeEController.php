...
class KuesionerTypeEController extends Controller
{
    ...
    {
        \DB::beginTransaction();
        KuesionerHelper::kuesionerTypeC($request, 5);
        \DB::commit();

        toaster_success('create form success');
        return redirect('kuesioner/E/create');
    }

    public function update(Request $request, $id)
    {
        \DB::beginTransaction();
        KuesionerHelper::kuesionerTypeC($request, 5, $id);
        \DB::commit();
