        ...
        <div class="col-lg-12">
            <div class="card p-20">
                <div class="card-header">
                    ...
                    <p class="text-muted m-b-30 font-13">Pertanyaan dengan jawaban isian lebih dari satu</p>
                </div>
                <form class="form-material m-t-40" action="{{url('kuesioner/B/'.$kuesioner->id)}}" method="post">
                    {!! csrf_field() !!}
