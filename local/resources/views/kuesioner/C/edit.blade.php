        ...
        <div class="col-lg-12">
            <div class="card p-20">
                <div class="card-header">
                    ...
                    <p class="text-muted m-b-30 font-13"> Pertanyaan dengan jawaban pilihan ganda </p>
                </div>
                <form class="form-material m-t-40" action="{{url('kuesioner/C/'.$kuesioner->id)}}" method="post">
                    {!! csrf_field() !!}
