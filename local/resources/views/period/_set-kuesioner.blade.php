<div class="modal-dialog modal-lg">
    <div class="modal-content">
        <div class="modal-header">
            <h4 class="modal-title" >{{$period->name}} <br>
            Jumlah Kuesioner : {{\App\Models\KuesionerPeriode::where('periode_id', $period->id)->count()}}
            </h4>
            ...
            <div class="modal-body col-lg-12">
                <div class="table-responsive">
                    <table class="table color-table info-table">
                        ...
                        <?php
                        $set_kueisoner = \App\Models\KuesionerPeriode::where('kuesioner_id', $kuesioner->id)->where('periode_id', $period->id)->first();
                        ?>
                        <tr>
                            <td>
                            ...
                            <td>{{$kuesioner->kuesioner}} {!!$kuesioner->isPublished()!!} <br><i class="text-warning" style="font-size:12px">{{$kuesioner->group ? $kuesioner->group->name : ''}}</i class="text-warning"></td>
                        </tr>   
                        @endforeach 
                    </table>
                </div>
