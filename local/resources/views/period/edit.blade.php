    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card p-20">
                ...
                <form class="form-material m-t-40" action="{{url('period/'.$period->id)}}" method="post">
                    {!! csrf_field() !!}
                    <input name="_method" type="hidden" value="PUT">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label class="control-label">Nama periode*</label>
                            <input type="text" value="{{$period->name}}" required id="name" name="name" class="form-control" placeholder="">
                        </div>
...
<script>
    $(function () {
        $("#range").ionRangeSlider({
            ...
            min: 0,
            max: 100,
            from: {{$period->lower_limit}},
            to: {{$period->upper_limit}},
            type: 'double',
            step: 1,
            prefix: "mount ",
            grid: true
